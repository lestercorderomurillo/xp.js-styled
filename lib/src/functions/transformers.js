...
const size = ({ key, value }, theme) => {
    ...
    if (typeof value === 'string' && key === "fontSize") {
        const sizeKey = (_d = (_c = value.match(/\b(xxs|xs|sm|md|lg|xl|xxl)\b/i)) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.toLowerCase();
        const fontSize = sizeKey ? (_f = (_e = theme === null || theme === void 0 ? void 0 : theme.fontSizes) === null || _e === void 0 ? void 0 : _e[sizeKey]) !== null && _f !== void 0 ? _f : constants_1.FontSizes[sizeKey] : undefined;
        return fontSize !== undefined ? fontSize : value;
    }
    // Handle spacing resolution as default if size key is valid
    if (typeof value === 'string') {
        const sizeKey = (_h = (_g = value.match(/\b(xxs|xs|sm|md|lg|xl|xxl)\b/i)) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.toLowerCase();
        const spacing = sizeKey ? (_k = (_j = theme === null || theme === void 0 ? void 0 : theme.spacing) === null || _j === void 0 ? void 0 : _j[sizeKey]) !== null && _k !== void 0 ? _k : constants_1.Spacing[sizeKey] : undefined;
