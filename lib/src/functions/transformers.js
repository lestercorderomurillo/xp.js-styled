...
const size = ({ key, value }, theme) => {
    ...
    switch (key) {
        case "fontSize":
            resolvedSize = (_b = (_a = theme === null || theme === void 0 ? void 0 : theme.fontSizes) === null || _a === void 0 ? void 0 : _a[sizeKey]) !== null && _b !== void 0 ? _b : constants_1.FontSizes[sizeKey];
            break;
        case "fontWeight":
            resolvedSize = (_d = (_c = theme === null || theme === void 0 ? void 0 : theme.fontWeights) === null || _c === void 0 ? void 0 : _c[sizeKey]) !== null && _d !== void 0 ? _d : constants_1.FontWeights[sizeKey];
            break;
        default:
            resolvedSize = (_f = (_e = theme === null || theme === void 0 ? void 0 : theme.spacing) === null || _e === void 0 ? void 0 : _e[sizeKey]) !== null && _f !== void 0 ? _f : constants_1.Spacing[sizeKey];
    }
