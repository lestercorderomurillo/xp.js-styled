...
const size = ({ key, value }, theme) => {
    ...
    if (!(0, utils_1.isString)(value))
        return value;
    if (key === "fontWeight") {
        const weightValue = constants_1.FontWeights[value];
    ...
    switch (key) {
        case "fontSize":
            ...
            break;
        default:
            resolvedSize = (_d = (_c = theme === null || theme === void 0 ? void 0 : theme.spacing) === null || _c === void 0 ? void 0 : _c[sizeKey]) !== null && _d !== void 0 ? _d : constants_1.Spacing[sizeKey];
    }
