...
exports.createStyledComponent = void 0;
 ...
 */
const createStyledComponent = (Component, schema) => {
    return (0, react_1.forwardRef)((props, ref) => {
        ...
        const mergedProps = (0, react_1.useMemo)(() => {
            ...
            return {
                ...
                styleProps: (0, transformers_1.deepMerge)([
...
//# sourceMappingURL=createStyledComponent.js.map