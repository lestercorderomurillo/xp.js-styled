...
exports.deepMerge = exports.hexToRGB = exports.isNullish = exports.isJSON = exports.isString = exports.isObject = exports.isFunction = exports.isStyleProp = exports.isEventProp = void 0;
...
const hexToRGB = (hex) => {
    ...
    return hex.replace(/^#/, '').match(/\w\w/g).map((hex) => parseInt(hex, 16));
};
