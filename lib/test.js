...
const ColorSample = () => {
    ...
    return (<react_native_1.FlatList numColumns={17} data={colorLumens} keyExtractor={(item) => `${item.colorName}-${item.lumen}`} renderItem={({ item, index }) => (<react_native_1.View style={{
