...
const createStyled = (Component, schema) => {
  return ({ children, ...componentProps }) => {
    ...
    const transpile = (0, react_1.useCallback)(
      (values) => {
        var _a, _b;
        ...
        return (0, transformers_1.deepMap)({
          values: (0, transformers_1.normalizeMediaQueries)(
            values,
            (_b = schema === null || schema === void 0 ? void 0 : schema.theme) === null || _b === void 0 ? void 0 : _b.breakpoints,
          ),
          skipKeys: ["children"],
