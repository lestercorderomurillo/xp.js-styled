...
const createStyled = (Component, schema) => {
    return ({ ...args }) => {
        var _a;
        const schemaWithQuery = (0, transformers_1.media)(schema !== null && schema !== void 0 ? schema : {}, (_a = schema === null || schema === void 0 ? void 0 : schema.theme) === null || _a === void 0 ? void 0 : _a.breakpoints);
