...
const useDebouncedState_1 = __importDefault(require("../hooks/useDebouncedState"));
...
const createStyled = (Component, schema) => {
    return (props) => {
        const deviceColorScheme = (0, useDebouncedState_1.default)((0, react_native_1.useColorScheme)());
        const deviceDimensions = (0, useDebouncedState_1.default)((0, react_native_1.useWindowDimensions)());
        ...
        const memoized = (0, react_1.useMemo)(() => {
            ...
            const { elementProps, styleProps } = (0, transformers_1.splitProps)({
                props: restProps,
                parser: compile,
            });
        ...
        return (<Component {...memoized.elementProps} style={(0, utils_1.deepMerge)([memoized.schemaStyle, memoized.variantStyle, memoized.inlineStyle, memoized.overrideStyle])}/>);
    };
};
