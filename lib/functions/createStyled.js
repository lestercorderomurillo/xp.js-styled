...
const createStyled = (Component, schema) => {
    return ({ ...args }) => {
        ...
        const memo = (0, react_1.useMemo)(() => {
            var _a;
            const schemaStyle = (0, transformers_1.deepTransform)((0, transformers_1.media)(schema !== null && schema !== void 0 ? schema : {}, (_a = schema === null || schema === void 0 ? void 0 : schema.theme) === null || _a === void 0 ? void 0 : _a.breakpoints), schema === null || schema === void 0 ? void 0 : schema.theme);
            const style = (0, transformers_1.deepTransform)(args.style, schema === null || schema === void 0 ? void 0 : schema.theme);
            const variantStyle = (schema === null || schema === void 0 ? void 0 : schema.variants) && (args === null || args === void 0 ? void 0 : args.variant) && (schema === null || schema === void 0 ? void 0 : schema.variants[args.variant]) ? (0, transformers_1.deepTransform)(schema === null || schema === void 0 ? void 0 : schema.variants[args.variant], schema === null || schema === void 0 ? void 0 : schema.theme) : {};
            return {
                style,
                variantStyle,
                schemaStyle,
        ...
        return <Component {...args} style={(0, utils_1.deepMerge)([memo.schemaStyle, memo.style, memo.variantStyle])}/>;
    };
};
