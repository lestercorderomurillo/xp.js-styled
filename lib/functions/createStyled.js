...
const createStyled = (Component, schema) => {
    return ({ ...args }) => {
        ...
        const memo = (0, react_1.useMemo)(() => {
            ...
            const variantStyle = (schema === null || schema === void 0 ? void 0 : schema.variants) && (schema === null || schema === void 0 ? void 0 : schema.variants[args.variant]) ? (0, transformers_1.deepTransform)(schema === null || schema === void 0 ? void 0 : schema.variants[args.variant], schema === null || schema === void 0 ? void 0 : schema.theme) : {};
            return {
                style,
                variantStyle,
                schemaStyle,
