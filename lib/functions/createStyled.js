...
const createStyled = (Component, schema) => {
    return ({ children, ...props }) => {
        ...
        return (<Component {...(children ? { children } : {})} {...memoized.elementProps} style={(0, utils_1.deepMerge)([memoized.schemaStyle, memoized.variantStyle, memoized.inlineStyle, memoized.overrideStyle], ['children', 'style'])}/>);
    };
};
