...
const createStyled = (Component, schema) => {
  return ({ children, ...props }) => {
    ...
    const transpile = (values) => {
      var _a;
      const colorRegex = new RegExp(
        `\\b(?:${Object.keys({ ...constants_1.ColorPallete, ...((_a = schema === null || schema === void 0 ? void 0 : schema.theme) === null || _a === void 0 ? void 0 : _a.colors) }).join("|")})\\.${constants_1.ColorIntensity}\\b`,
      );
      return (0, transformers_1.deepMap)({
        values: (0, transformers_1.normalizeMediaQueries)(values, schema === null || schema === void 0 ? void 0 : schema.theme.breakpoints),
        skipKeys: ["children"],
        match: (value) => (0, utils_1.isString)(value),
        map: ({ key, value }) => {
          var _a;
          if (colorRegex.test(value)) {
            return (0, transformers_1.color)(
              value,
              (_a = schema === null || schema === void 0 ? void 0 : schema.theme) === null || _a === void 0 ? void 0 : _a.colors,
              schema === null || schema === void 0 ? void 0 : schema.theme.breakpoints,
            );
    ...
    const memoized = (0, react_1.useMemo)(() => {
      ...
      let parentStyle = {};
      (_a = schema === null || schema === void 0 ? void 0 : schema.parentStyles) === null || _a === void 0
        ? void 0
        : _a.forEach((styleName) => {
            var _a, _b;
            parentStyle = (0, transformers_1.deepMerge)([
              parentStyle,
              (_b =
                (_a = schema === null || schema === void 0 ? void 0 : schema.theme) === null || _a === void 0
                  ? void 0
                  : _a.styles[styleName]) !== null && _b !== void 0
                ? _b
                : {},
            ]);
          });
      const variantStyle =
        variant && (schema === null || schema === void 0 ? void 0 : schema.variants) && schema.variants[variant]
    ...
    return (
      <Component
        {...(children ? { children } : {})}
        {...memoized.elementProps}
        style={(0, transformers_1.deepMerge)(
