...
const createStyled = (Component, schema) => {
    return ({ children, ...componentProps }) => {
        ...
        return (<Component {...props.elementProps} children={children} style={(0, transformers_1.deepMerge)([props.parentStyle, props.schemaStyle, props.variantStyle, props.inlineStyle, props.overrideStyle], ["children", "style"])}/>);
    };
};
