    ...
    for (const key in props) {
        ...
        if (typeof value === "string") {
            if (constants_1.ColorRegex.test(value)) {
                output[key] = (0, exports.color)(value, colorsSchema, false);
            }
            else if (constants_1.SizeRegex.test(value)) {
                output[key] = (0, exports.size)(value, sizeSchema);
            }
        }
        else if (typeof value === "object") {
            output[key] = (0, exports.resolveStyleProps)(props, colorsSchema, sizeSchema);
        }
    }
    return output;
};
...
const color = (value, colors, ignoreOwn = true) => {
    ...
    if (constants_1.ColorRegex.test(value)) {
        ...
        const color = constants_1.ColorPallete[colorName];
        if (color) {
            return (0, exports.reshade)(color, parseInt(lumen));
        }
    }
