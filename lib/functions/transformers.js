...
exports.size = exports.color = exports.shade = exports.media = exports.deepTransform = exports.deepColor = exports.deepSize = exports.deepMap = exports.splitProps = void 0;
...
const deepSize = (props, sizeSchema) => {
    return (0, exports.deepMap)({
        input: props,
        match: (value) => (0, utils_1.isString)(value) && constants_1.SizeRegex.test(value),
