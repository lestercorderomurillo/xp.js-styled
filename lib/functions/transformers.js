    ...
    for (const key in values) {
      if (!skipKeys.includes(key)) {
        let ctx = {
          ...initialContext,
          deep:
            (_a = initialContext === null || initialContext === void 0 ? void 0 : initialContext.deep) !== null && _a !== void 0 ? _a : 0,
        };
...
const normalizeMediaQueries = (values, breakpoints) => {
  ...
  if ((0, utils_1.isObject)(values) && Object.keys(values).length > 0) {
    ...
    return (0, exports.deepMerge)([
      out,
      (0, exports.normalizeMediaQueries)((_a = values[`@${colorScheme}`]) !== null && _a !== void 0 ? _a : {}),
    ]);
  }
  return values;
};
...
const size = ({ key, value }, theme) => {
  ...
  if (!(0, utils_1.isString)(value)) return value;
  ...
  switch (key) {
    case "fontSize":
      resolvedSize =
        (_d = (_c = theme === null || theme === void 0 ? void 0 : theme.fontSizes) === null || _c === void 0 ? void 0 : _c[sizeKey]) !==
          null && _d !== void 0
          ? _d
          : constants_1.FontSizes[sizeKey];
      break;
    case "fontWeight":
      resolvedSize =
        (_f = (_e = theme === null || theme === void 0 ? void 0 : theme.fontWeights) === null || _e === void 0 ? void 0 : _e[sizeKey]) !==
          null && _f !== void 0
          ? _f
          : constants_1.FontWeights[sizeKey];
      break;
    default:
      resolvedSize =
        (_h = (_g = theme === null || theme === void 0 ? void 0 : theme.spacing) === null || _g === void 0 ? void 0 : _g[sizeKey]) !==
          null && _h !== void 0
          ? _h
          : constants_1.Spacing[sizeKey];
  }
