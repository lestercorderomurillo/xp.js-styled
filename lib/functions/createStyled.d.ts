 ...
 */
export declare const createStyled: <TComponent extends React.ComponentType<{}>, TStyleProps = ComponentStyleProps<TComponent>, TVariantNames extends string = never>(Component: TComponent, schema?: StyledSchema<TStyleProps, TVariantNames>) => ({ children, ...componentProps }: StyledProps<React.ComponentProps<TComponent>, ComponentStyleProps<TComponent>, keyof StyledSchema<TStyleProps, TVariantNames>["variants"]>) => React.JSX.Element;
